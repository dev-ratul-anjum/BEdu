            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <Paragraph className="!mb-0 text-sm font-medium">{session.time}</Paragraph>
                </div>
                <div>
                  <Text className="text-gray-500 text-xs">Subject</Text>
                ...
                <div>
                  ...
                  <Paragraph className="!mb-0 text-sm font-medium">{session.room}</Paragraph>
                </div>
                <div>
