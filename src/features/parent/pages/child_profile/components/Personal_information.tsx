      ...
      <Row gutter={[16, 16]}>
        ...
        >
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <Text className="text-sm text-gray-600 block mb-2">Blood Group</Text>
            <Title
              level={4}
              className="!mb-0"
            >
        ...
        >
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
            <Text className="text-sm text-gray-600 block mb-2">Nationality</Text>
            <Title
              level={4}
              className="!mb-0"
            >
        ...
        >
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            <Text className="text-sm text-gray-600 block mb-2">Guardian Contact</Text>
            <Title
              level={4}
