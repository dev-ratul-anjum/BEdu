        ...
        >
          <div className="text-center">
            ...
            <Paragraph className="!mt-4 !mb-0">
              <Text className="block text-sm text-gray-500">Student ID</Text>
              <Text className="block text-lg font-semibold">{rollNumber}</Text>
            </Paragraph>
          </div>
        </Col>
            ...
            <Row gutter={[16, 16]}>
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <Text className="text-sm font-medium">johnnie@example.com</Text>
                  </div>
                </div>
              </Col>
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <Text className="text-xs text-gray-500 block">Contact</Text>
                    <Text className="text-sm font-medium">+1 (555) 123-4567</Text>
                  </div>
                </div>
              </Col>
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <Text className="text-xs text-gray-500 block">DOB</Text>
                    <Text className="text-sm font-medium">15 May 2010</Text>
                  </div>
                </div>
              </Col>
            </Row>
