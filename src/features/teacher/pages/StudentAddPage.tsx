...
const SectionHeader = ({ title }: { title: string }) => (
  <div className="mb-6 border-b border-gray-200 pb-2">
    <h3 className="text-lg font-semibold text-blue-900 uppercase">{title}</h3>
  </div>
);
...
const SelectField = ({ label, options, placeholder, required = false, className = '' }: any) => (
  <div className={`flex flex-col ${className}`}>
    <label className="mb-2 text-xs font-semibold text-gray-500 uppercase">
      {label} {required && <span className="text-red-500">*</span>}
    </label>
...
const DatePicker = ({ label, placeholder, required = false, className = '' }: any) => (
  <div className={`flex flex-col ${className}`}>
    <label className="mb-2 text-xs font-semibold text-gray-500 uppercase">
      {label} {required && <span className="text-red-500">*</span>}
    </label>
...
const FileUpload = ({
  ...
  <div className={`flex flex-col ${className}`}>
    <label className="mb-2 text-xs font-semibold text-gray-500 uppercase">{label}</label>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 font-sans">
      ...
      <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <h1 className="text-2xl font-bold text-blue-900">Add Student</h1>
          <nav className="text-sm text-gray-500">
            <span>Dashboard</span> <span className="mx-2">|</span> <span>Student Info</span>{' '}
            <span className="mx-2">|</span> <span className="text-blue-600">Student Admission</span>
          </nav>
        </div>
