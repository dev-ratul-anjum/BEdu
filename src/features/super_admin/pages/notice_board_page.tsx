...
const MOCK_NOTICES: Notice[] = [
    ...
    },
    {
        ...
        content:
            'School will remain closed for winter break from Dec 20th to Jan 5th. Happy Holidays!',
        targetRoles: ['All'],
        status: 'Published',
        priority: 'Low',
        author: 'Admin Office',
    ...
    },
    {
        ...
        content:
            'We have introduced new healthy options in the cafeteria menu starting next week.',
        ...
        return notices
            .filter(n => {
                ...
                const matchesRole = filterRole
                    ? n.targetRoles.includes(filterRole as Role) ||
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1 ml-1">
                            Manage school announcements, circulars, and exam
                            updates.
                        </p>
                    </div>
                    <button
                        ...
                        <div className="flex flex-wrap gap-3 w-full lg:w-auto">
                            ...
                            <div className="border-l pl-3 ml-1 flex items-center bg-gray-100 rounded-lg p-1">
                                ...
                                >
                                    ...
                                    {/* Using generic icon for grid view metaphor */}
                                </button>
                            </div>
                        </div>
                    </div>
