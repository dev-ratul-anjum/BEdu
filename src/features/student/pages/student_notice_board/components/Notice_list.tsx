          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {notice.is_pinned && <Pin className="h-4 w-4 text-orange-500 fill-orange-500" />}
                {!notice.is_read && <div className="w-2 h-2 bg-blue-500 rounded-full" />}
              </div>

              <div className="flex items-center gap-2 mb-3">
                <Tag color={get_category_color(notice.category)}>{notice.category}</Tag>
