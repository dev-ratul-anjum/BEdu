...
import Class_details from '@/features/admin/management/class_management/components/Class_details';
import Class_form from '@/features/admin/management/class_management/components/Class_form';
import Class_management from '@/features/admin/management/class_management/Class_management';
import Section_edit from '@/features/admin/management/class_management/components/Section_edit';
import Department_form from '@/features/admin/management/department_management/components/Department_form';
