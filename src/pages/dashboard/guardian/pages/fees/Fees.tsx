...
const Fees: React.FC = () => {
    ...
    const handle_pay = (row: Invoice) => {
        set_invoices(prev =>
            prev.map(i => (i.key === row.key ? { ...i, status: 'paid' } : i))
        );
    };
                ...
                {active_invoice ? (
                    <div>
                        <p>
                            ...
                            {active_invoice.invoice_no}
                        </p>
                        <p>
                            <strong>Student:</strong>{' '}
                            {active_invoice.student_name}
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            {active_invoice.amount.toFixed(2)}
                        </p>
                        <p>
                        ...
                        <hr />
                        <p className="text-sm text-gray-600">
                            Additional invoice details can be shown here —
                            breakdown, items, payment history, notes, etc.
                        </p>
                    </div>
                ) : (
